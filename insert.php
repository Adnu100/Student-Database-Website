<html>
	<head>
		<title> Student Inforamation Insertion Form </title>
		<link rel = "stylesheet" type = "text/css" href = "buttonmaking.css">
	</head>
	<body bgcolor = "aqua">
		<center> <h1 class = "myheader"> New Student Form </h1> </center>
		<hr>
		<hr>
		<br>
		<br>
		...
		<form action = "Coep.php" method = "post">
			<center> <table border = "2" align = "center" class = "tablestyle">
				<tr>
					<center> <b style = "font-size : 200%;"> Fill the following information : </b> </center>
				</tr>
				<tr>
